...
\begin{tikzpicture}[
    ...
    gcdata/.style  = {gcbox, draw=adobegray, fill=white, inner sep=4pt,
  ...
  % ---------------- the two recoveries ------------------------------------
  \coordinate (fan) at ($(gate.south)+(0,-0.40)$);

  \node[gcdet, text width=5.8cm, anchor=north west]
    (retry) at ($(gate.south west)+(0,-1.02)$)
  ...
  \node[gcdet, text width=5.8cm, anchor=north east]
    (fall) at ($(gate.south east)+(0,-1.02)$)
  ...
  % ---------------- execution --------------------------------------------
  \coordinate (mrg) at ($(fall.south)+(0,-0.58)$);
  \node[gcdet, text width=13.1cm, anchor=north]
    (exec) at ($(0,0 |- mrg)+(0,-0.30)$)
